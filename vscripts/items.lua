...
function COverthrowGameMode:MythicWeaponAttributeValue( attribute )
	...
	if attribute == "% Ability Crit (500%)" and COverthrowGameMode.version == 1 then
		return 0.33333
	end
	if attribute == "% Ability Crit (500%)" and COverthrowGameMode.version == 2 then
		return 0.11
	end
	...
	if attribute == "% Attack Crit (500%)" and COverthrowGameMode.version == 1 then
		return 0.33333
	end
	if attribute == "% Attack Crit (1000%)" and COverthrowGameMode.version == 2 then
		return 0.25
	end
	...
	if attribute == " Rune Power: FAH" or attribute == " Rune Power: WII" or attribute == " Rune Power: LOO" or attribute == " Rune Power: TAL" or attribute == " Rune Power: NAH" or attribute == " Rune Power: ZER" or
			attribute == " Rune Power: TEM" or attribute == " Rune Power: TIC" or attribute == " Rune Power: KIL" or attribute == " Rune Power: ROH" then
	...
	if attribute == " Primary Attribute" then
		return 1
	end
...
function GetGeneratedItemType(weapon) -- attributes per category
	...
	local category = 1
	--str
	if suffix == "str" or suffix == "phy" or suffix == "phd" or suffix == "fah" or suffix == "loo" or suffix == "wii" or suffix == "tal" or suffix == "zer" or suffix == "nah" or suffix == "tem" or suffix == "tic" or suffix == "kil" or suffix == "roh" or suffix == "aoe" then
		category = 1
	end
	--agi
	if suffix == "agi" or suffix == "ats" or suffix == "aac" or suffix == "aad" or suffix == "mov" or suffix == "cha" or suffix == "chd" or suffix == "sha" or suffix == "shd" then
		category = 2
	end
	--int
	if suffix == "int" or suffix == "spp" or suffix == "man" or suffix == "arc" or suffix == "ard" or suffix == "fir" or suffix == "fid" or suffix == "hol" or suffix == "hod" or suffix == "fro" or suffix == "frd" or suffix == "sin" or suffix == "sph" then
		category = 3
	end
	--def
	if suffix == "arm" or suffix == "res" or suffix == "hpp" or suffix == "blo" or suffix == "nat" or suffix == "nad" or suffix == "hea" or suffix == "cdr"or suffix == "mhp" then
		category = 4
	end
	--offensive neutral
	if suffix == "aaa" or suffix == "crd" or suffix == "abc" or suffix == "ene" or suffix == "abp" or suffix == "abi" or suffix == "pat" or suffix == "arr" or suffix == "dot" then
		category = 5
	end
	return category
end
...
COverthrowGameMode.HeroStatsData = {
    ...
    --crit procs
    {"abc", 0.05, " % Ability Crit (500%)", "Executioner", "Final", "Execution"}, --weapons, shoulder, ring
    {"abd", 0.025, " % Ability Crit (1000%)", "Cataclysm", "Cataclysmic", "Cataclysm"}, --weapons, shoulder, ring
    {"aac", 0.025, " % Attack Crit (1000%)", "Deadly", "Deadly", "Conflict"}, --weapons
    {"aae", 0.05, " % Attack Crit (500%)", "Piercer", "Piercing", "Piercing"} --weapons
}

--new generated items
COverthrowGameMode.GeneratedItemData = {
    {"str", " Strength", "Grizzly", "Giant", "Power"}, --first is attribute given, 2 3 4 are item name suffixes
    ...
    {"abc", "% Ability Crit (500%)", "Executioner", "Final", "Execution"}, --weapons, shoulder, ring
    ...
    {"aac", "% Attack Crit (1000%)", "Deadly", "Deadly", "Conflict"}, --weapons
    {"hpp", " Max Health", "Titan", "Immense", "Might"}, --not weapons and ring
    {"man", " Max Mana", "Nether", "Endless", "Wisdom"}, 
    ...
    {"blo", " Block", "Massive", "Massive", "Walls"}, --offhand, chest, shoulder
...
function IsStatAllowedForItemSlot(stat, slot)
	--exceptions
	if slot == 7 and (stat:sub(1,1) == "y" or stat:sub(1,1) == "z" or stat == "arr" or stat == "srr" or stat == "aad" or stat == "mov" or stat == "fah" or stat == "loo" or stat == "wii" or stat == "tal" or stat == "zer"
	...
	if slot == 5 and (stat:sub(1,1) == "y" or (stat:sub(1,1) == "z" and not stat == "zer") or stat == "arr" or stat == "srr" or stat == "aaa" or stat == "ats" or stat == "crd" or stat == "abc" or stat == "aac" or stat == "ene" or stat == "abp" or stat == "hea" or stat == "cdr" or stat == "blo" or stat == "aad" or stat == "abi" or stat == "pat" or stat == "mov"
			 or stat == "fah" or stat == "loo" or stat == "wii"
	...
	if slot == 6 and (stat:sub(1,1) == "y" or stat:sub(1,1) == "z" or stat == "arr" or stat == "srr" or stat == "aaa" or stat == "ats" or stat == "crd" or stat == "abc" or stat == "aac" or stat == "ene" or stat == "abp" or stat == "hea" or stat == "cdr" or stat == "blo" or stat == "aad" or stat == "abi" or stat == "pat"
			 or stat == "fah" or stat == "loo" or stat == "wii" or stat == "tal" or stat == "zer"
	 		or stat == "nah" or stat == "roh"  or stat == "aoe" or stat == "sin" or stat == "dot" or stat == "mhp" or stat == "sph") then
		return false
	end
	if slot == 1 and (stat:sub(1,1) == "y" or stat:sub(1,1) == "z" or stat == "arr" or stat == "srr" or stat == "crd" or stat == "arm" or stat == "res" or stat == "hpp" or stat == "blo" or stat == "abi" or stat == "pat" or stat == "mov" or stat == "fah" or stat == "loo" or stat == "wii" or stat == "tal" or stat == "zer"
	 		or stat == "nah"  or stat == "tem" or stat == "tic" or stat == "kil" or stat == "roh" or stat == "mhp") then
		return false
	end
	if slot == 2 and (stat:sub(1,1) == "y" or stat:sub(1,1) == "z" or stat == "arm" or stat == "res" or stat == "hpp" or stat == "abi" or stat == "pat" or stat == "mov" or stat == "fah" or stat == "loo" or stat == "wii" or stat == "tal" or stat == "zer"
	 		or stat == "nah"  or stat == "tem" or stat == "tic" or stat == "kil" or stat == "roh" or stat == "mhp" or stat == "sph") then
		return false
	end
	if slot == 3 and (stat:sub(1,1) == "y" or stat:sub(1,1) == "z" or stat == "arr" or stat == "srr" or stat == "aaa" or stat == "ats" or stat == "arm" or stat == "res" or stat == "aac" or stat == "hpp" or stat == "ene" or stat == "abp" or stat == "cdr" or stat == "blo" or stat == "mov"
			 or stat == "fah" or stat == "loo" or stat == "wii" or stat == "tal" or stat == "zer"
	 		or stat == "nah"  or stat == "tem"  or stat == "tic"  or stat == "kil" or stat == "roh"  or stat == "aoe" or stat == "sin" or stat == "dot" or stat == "mhp" or stat == "sph") then
		return false
	end
	if slot == 8 and (stat == "fah" or stat == "loo" or stat == "wii" or stat == "tal" or stat == "zer"
	 		or stat == "nah"  or stat == "tem" or stat == "tic" or stat == "kil" or stat == "roh" or stat == "mhp" or stat == "sph") then
		return false
	end
	return true
...
function COverthrowGameMode:GetGeneratedItemRandomStatTypes(slot)
	local chance_for_reroll_on_elemental_stat = 100 --twice reroll ele bonus
	local stats = {}
	stats[1] = COverthrowGameMode:GetGeneratedItemRandomStatType("no", "no", slot)
	...
	stats[2] = COverthrowGameMode:GetGeneratedItemRandomStatType(stats[1], "no", slot)
	...
	stats[3] = COverthrowGameMode:GetGeneratedItemRandomStatType(stats[1], stats[2], slot)
...
function COverthrowGameMode:GetGeneratedItemRandomStatType(exclude_1, exclude_2, slot)
	...
	if slot == 8 then
		--amulets have a chance to roll path bonuses
		if math.random(1,100) <= 10 then
			stat = COverthrowGameMode.GeneratedItemData[math.random(COverthrowGameMode.GeneratedItemDataPathIndex,#COverthrowGameMode.GeneratedItemData)][1]
		end
	end
	...
	if stat ~= exclude_1 and stat ~= exclude_2 and IsStatAllowedForItemSlot(stat, slot) and ((not COverthrowGameMode:IsRunePowerStat( stat )) or ((not COverthrowGameMode:IsRunePowerStat( exclude_1 )) and (not COverthrowGameMode:IsRunePowerStat( exclude_2 )))) then
		return stat
	else
		return COverthrowGameMode:GetGeneratedItemRandomStatType(exclude_1, exclude_2, slot)
	end
end
...
function COverthrowGameMode:IsRunePowerStat( stat )
	...
	if stat == "zer" or stat == "nah" or stat == "tem" or stat == "tic" or stat == "kil" or stat == "fah" or stat == "loo" or stat == "wii" or stat == "tal" or stat == "roh" then
		--print("yes")
		return true
	else
		return false
...
function COverthrowGameMode:GetMythicWeaponAttributeName(weapon, attribute)
	...
	if weapon:sub(6,8) == "gen" then --old weapon:sub(1,8) == "aimo7gen"
		if attribute == 0 then
	...
	if weapon == "lege2spearcanefire" then
		if attribute == 0 then
			return "Sceptre of Might" -- item name
		end
		if attribute == 1 then
			return " Spellpower"
		end
...
function COverthrowGameMode:GetMythicWeaponMaxLevel(quality, number_attributes, weaponslot)
	...
	if self.version == 2 then
		if quality == "epic" and number_attributes == 2 then
			value = 15
		end
		if quality == "epic" and number_attributes == 3 then
			value = 15
		end
		if quality == "leg" and number_attributes == 3 then
			value = 25
		end
		if quality == "leg" and number_attributes == 2 then
			value = 25
		end
		if quality == "im" and number_attributes == 3 then
			value = 50
		end
		if quality == "im" and number_attributes == 2 then
			value = 50
		end
		if quality == "im" and (weaponslot == 4 or weaponslot == 5 or weaponslot == 6) then
			value = 50
		end
		--ancient
		if quality == "aim" and number_attributes == 3 then
			value = 75
		end
		if quality == "aim" and number_attributes == 2 then
			value = 75
		end
		if quality == "aim" and (weaponslot == 4 or weaponslot == 5 or weaponslot == 6) then
			value = 75
		end
		--divine
		...
		if quality == "myth" and weaponslot == 8 then
			value = 75
		end
	end
...
function COverthrowGameMode:CreateMythicWeapon( hero, weapon, fromserver, a1, a2, a3, dropped_from_boss )
	...
	if not fromserver and weapon and weapon:sub(6,8) == "gen" then --is it a generated item?
		is_generated_shoulder = true
		local generated_stat_types = COverthrowGameMode:GetGeneratedItemRandomStatTypes(weaponslot)
	...
	if not fromserver then
		totalstats = math.random(self:GetMythicWeaponMinLevel(quality,number_attributes,weaponslot), self:GetMythicWeaponMaxLevel(quality,number_attributes,weaponslot))
	...
	if not fromserver then
		...
		if weapondrop[5] < 1.0 and not (string.sub(weapondrop[8], 1, 6) == " Path:") then
			weapondrop[5] = 1
		end
		if weapondrop[6] < 1.0 and not (string.sub(weapondrop[9], 1, 6) == " Path:") then
			weapondrop[6] = 1
		end
		if weapondrop[7] < 1.0 and not (string.sub(weapondrop[10], 1, 6) == " Path:") then
			weapondrop[7] = 1
		end
...
function GetAllItems(unit, always_show_boss_specific_drops, return_drop_quantity, act_specific_loot_factor)
	...
	local act_11_drop_factor = 3 * act_specific_loot_factor -- bonus factor on some bosses
	...
	for k=1, act_11_drop_factor do
		...
		if (unit and unit.act and unit.act == 4) or always_show_boss_specific_drops then
		...
		if (unit and unit.act and unit.act == 5) or always_show_boss_specific_drops then
		...
		if (unit and unit.act and unit.act == 6) or always_show_boss_specific_drops then
		...
		if (unit and unit.act and unit.act == 7) or always_show_boss_specific_drops then
		...
		if (unit and unit.act and unit.act == 8) or always_show_boss_specific_drops then
		...
		if (unit and unit.act and unit.act == 9) or always_show_boss_specific_drops then
		...
		if (unit and unit.act and unit.act == 10) or always_show_boss_specific_drops then
			...
			table.insert(items[10], "item_crown")
		...
		if (unit and unit.act and unit.act == 12) or always_show_boss_specific_drops then
...
function COverthrowGameMode:DropTempleItem( unit, reward, drop_type, buy_quality, artifact )
	...
	if normal_drop then
		CustomGameEventManager:Send_ServerToAllClients( "report_drop_chance", {value = unit.pvescale, boss = wasbosskill} )
	end
	...
	if normal_drop then
		local scalefactor = 1.25 --1.75 * 2 * 1.1 -- *2 patch 4.3.1, *1.1 patch 4.4
		local extraFactor = 2.5 --season 5
		if COverthrowGameMode.jungledifficulty < 5 then --gradually
			extraFactor = 1.5
			if COverthrowGameMode.jungledifficulty < 2 then
				extraFactor = 1
			end
		end
		t8chance = extraFactor * 1.5 * 0.00005 * 100 * ((unit.pvescale * scalefactor) - (scalefactor-1)) * drop_chance_factor
		t7chance = extraFactor * 1.5 * 0.0005 * 100 * ((unit.pvescale * scalefactor) - (scalefactor-1)) * drop_chance_factor
		t6chance = extraFactor * 1.5 * 0.05 * 100 * ((unit.pvescale * scalefactor) - (scalefactor-1)) * drop_chance_factor
		t5chance = extraFactor * 1.5 * 0.5 * 100 * ((unit.pvescale * scalefactor) - (scalefactor-1)) * drop_chance_factor
		t4chance = extraFactor * 1.5 * 3 * 100 * ((unit.pvescale * scalefactor) - (scalefactor-1)) * drop_chance_factor
		t3chance = extraFactor * 10 * 100 * ((unit.pvescale * scalefactor) - (scalefactor-1)) * drop_chance_factor
		t2chance = 50 * 100 * ((unit.pvescale * scalefactor) - (scalefactor-1)) * drop_chance_factor -- 25% before 5.6
	...
	for itemDropCount = 1, maxItemDropCount do
		Timers:CreateTimer(0.05 + (itemDropCount - 1) * 3.25 * (#all),function()
			for i=1, #all do
				local hero = all[i]
				--does an item drop?
				if math.random(1,10000) <= reward * 100 then
						...
						if normal_drop and math.random(1,100) <= 0 then
							...
							elseif roll <= t6chance then --immortal
								...
								if COverthrowGameMode.jungledifficulty >= 100 and hero and hero.combat_system_ability then
									if unit.act and unit.act == 12 and math.random(1,100) <= 40 then
										Notifications:Top(hero:GetPlayerID(), {text="You received 1 Ebony Branch!", duration=5, style={color="orange"}})
										ApplyBuffStack({caster = hero, target = hero, ability = hero.combat_system_ability, dur = -1, addstacks = 1, buff = "modifier_jungle_token"})
									end
									if unit.act and unit.act == 13 and math.random(1,100) <= 90 then
										Notifications:Top(hero:GetPlayerID(), {text="You received 1 Ice Crystal!", duration=5, style={color="orange"}})
										ApplyBuffStack({caster = hero, target = hero, ability = hero.combat_system_ability, dur = -1, addstacks = 1, buff = "modifier_winter_token"})
									end
								end
						...
						if itemdrop then
							...
							Timers:CreateTimer(delay,function() 
							        ...
							        if all[i]:GetNumItemsInInventory() >= 6 then --and all[i]:GetNumItemsInStash() >= 6 then
							        	...
							        	Timers:CreateTimer(0.1,function()
								        	if item and not item:IsNull() then
									        	...
									        	item:LaunchLoot(false, 125, 0.9, all[i]:GetAbsOrigin()+Vector(offset_x,-offset_y,0))
						        ...
						        if item and not item:IsNull() then
						        	...
						        	local sellvalue = math.floor(item:GetCost() / 200.0)
						        	if sellvalue < 1 then
						        		sellvalue = 1
						        	end
						        	local player = PlayerResource:GetPlayer(hero:GetPlayerID())
...
function COverthrowGameMode:GetRandomDivineItem()
	...
	local index = math.random(1,COverthrowGameMode.maxtalents)
	if index <= 9 then
...
--[[
if (unit and unit.act and unit.act == 12) or always_show_boss_specific_drops then
		if unit.boss_in_act and unit.boss_in_act == 1 or unit.act_12_final_boss then
			local anc_item = "item_set_t4_agi_1"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_aa_2"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
		...
		if unit.boss_in_act and unit.boss_in_act == 2 or unit.act_12_final_boss then
			local anc_item = "item_set_t4_int_1"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_sp_1"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
		...
		if unit.boss_in_act and unit.boss_in_act == 3 or unit.act_12_final_boss then
			local anc_item = "item_set_t4_str_1"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_aa_1"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
		...
		if unit.boss_in_act and unit.boss_in_act == 4 or unit.act_12_final_boss then
			local anc_item = "item_set_t4_agi_2"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_sp_2"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
		...
		if unit.boss_in_act and unit.boss_in_act == 5 or unit.act_12_final_boss then
			local anc_item = "item_set_t4_int_2"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_new_3"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
		...
		if unit.boss_in_act and unit.boss_in_act == 6 or unit.act_12_final_boss then
			local anc_item = "item_set_t4_new_1"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_str_3"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
		...
		if unit.boss_in_act and unit.boss_in_act == 7 or unit.act_12_final_boss then
			local anc_item = "item_set_t4_int_3"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_sp_3"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
		...
		if unit.boss_in_act and unit.boss_in_act == 8 or unit.act_12_final_boss then
			local anc_item = "item_set_t4_agi_3"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_aa_3"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
		...
		if (not unit.boss_in_act) or unit.act_12_final_boss then
			local anc_item = "item_set_t4_new_2"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
			end
			anc_item = "item_set_t4_str_2"
			for i=1, act_11_drop_factor do
				table.insert(tier6str, anc_item)
				table.insert(tier6agi, anc_item)
				table.insert(tier6int, anc_item)
